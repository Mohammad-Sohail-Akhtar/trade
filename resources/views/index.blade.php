...
<body>
  ...
  <!-- navbar starts -->
    <nav class="navbar navbar-expand-lg">
       ...
       <!-- header starts -->
      <header>
        <div class="background_image flex">
          <div class="header-left">
            <img class="w-100" src="images/viber_ima.png" alt="" data-aos="fade-right" data-aos-duration="3000">
            
          </div>
          <div class="header-right">
            <h1 data-aos="fade-left" data-aos-duration="3000">Be on the top of the world with <span>TRADEGOD.</span></h1>
          </div>
        </div>
</header>
<!-- header ends -->

<p class="mid">"From youngsters to millennials and <br>broke to billionaires, <span style="color:red">TradeGod</span> is for everyone!!!"</p>


<button class="predict"><a href="{{url('/predict')}}">Prediction</a></button>
